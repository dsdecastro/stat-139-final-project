...
After removing universities that were missing lots of data in the pull from the IPEDS data center, we were left with $n = 1,855$ observations.
...
interaction.plot(
  ...
  fun = median,
  main = "Plotting Mask-mandated Days versus 2020 Covid Cases",
