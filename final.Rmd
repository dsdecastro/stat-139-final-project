...
<!-- I honestly think we should either elaborate on Forward step 1. or not include it at all? -->
...
- General correlation of religious with cases, brief overview of the 2020, 2021, total.cases decision
...
Note: make sure that interpretations of `religious` coefficients are consistent with the interpretation of the logarithmic transformation. 
