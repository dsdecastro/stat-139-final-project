...
- Forward step 1: For this model, we stepped forward from an intercept model. As a result, `forward.step1` incorporated 67 predictors. Rather tellingly, this list of predictors did not include `religiousYes`, or any interaction term with `religious`. 

<!-- I honestly think we should either elaborate on Forward step 1. or not include it at all? -->

<!-- I don't think forward step 2 is really necessary to interpret --> 
